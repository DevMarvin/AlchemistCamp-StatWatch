defmodule StatWatch.Auth do
    import Plug.Conn
    import Phoenix.Controller
    alias StatWatchWeb.Router.Helpers
    alias StatWatchWeb.ErrorView
    ...
    def call(conn, _) do
        ...
        cond do
            user = conn.assigns[:current_user] ->
                conn
            user = user_id && StatWatch.Accounts.get_user!(user_id) ->
    ...
    defp put_current_user(conn, user) do
        ...
        |> assign(:admin_user, !!user && !!user.credential && 
            (user.credential.email == "mmwanzi76@gmail.com"))
    end
end