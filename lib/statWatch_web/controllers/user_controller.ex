defmodule StatWatchWeb.UserController do
  use StatWatchWeb, :controller

  alias StatWatch.Accounts
  ...
  defp correct_user(%{assigns: %{current_user: current, admin_user: admin}, 
    ...
    redirect_user = if current, do: Routes.user_path(conn, :show, current), else: "/"
